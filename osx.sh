...
sudo scutil --set ComputerName "leandrocp-machine"
sudo scutil --set HostName "leandrocp-machine"
sudo scutil --set LocalHostName "leandrocp-machine"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "leandrocp-machine"
